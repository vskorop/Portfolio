...
import clickSfx from '../src/sounds/click.wav'
import navigationSfx from '../src/sounds/navigation.wav'
      ...
      <a.div
        ...
        <h1 className={tw`whitespace-pre text-6xl md:text-8xl font-bold tracking-tight`}>
          {transitionText((style) => (
            ...
            background={textColorSpring.background} text={textFaceMapping[mainActiveFaceIndex]?.text} />
            ))}
        </h1>
